...
!**************************************************************************************************
   subroutine init_filters(array1, array2)
      ...
      ! Input parameters
      !   1: constant   1  ; Filter type [1=first order low pass,2=second order low pass,3=second 
      !                      order notch,4=second order bandpass]
      !   2: constant   2  ; Filter frequency, or 1/time constant of first order filter [Hz] 
      !   3: constant   3  ; Damping ratio for second order lowpass filter, or 3dB (relative) 
      !                      bandwidth of Notch and bandpass filter [Hz]
      !   4: constant   4  ; not used for lowpass filters, reduction ratio for Notch filter [-], 
      !                      or time lead constant for bandpass filter [s]
